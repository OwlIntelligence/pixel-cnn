    ...
    for epoch in range(args.max_epochs):
        ...
        if epoch == 0:
            ...
            if args.load_params:
                ...
                feed_dict = make_feed_dict(d, init=True, mask_generator=train_mgen)  # manually retrieve exactly init_batch_size examples
        ...
        train_losses = []
        for d in train_data:
            feed_dict = make_feed_dict(d, mask_generator=train_mgen)
        ...
        test_losses = []
        for d in test_data:
            feed_dict = make_feed_dict(d, mask_generator=test_mgen)
