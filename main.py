...
with tf.Session() as sess:
    ...
    plotting.plt.savefig(os.path.join("plots",'%s_complete%s.png' % (args.data_set, exp_label)))
    plotting.plt.close('all')
    np.savez(os.path.join("plots",'%s_complete%s.npz' % (args.data_set, exp_label)), sample_x)
